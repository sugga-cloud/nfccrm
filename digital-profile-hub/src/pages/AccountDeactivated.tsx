    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      ...
      >
        ...
        <p className="text-slate-500 font-medium mb-8 leading-relaxed">
          Your account has been disabled by the system administrator. You no longer have permission to access this portal or its services.
        </p>
        ...
        <p className="mt-8 text-[9px] font-black uppercase tracking-[0.2em] text-slate-300">
          Security Reference: ERR_ACCOUNT_DISABLED
        </p>
      </motion.div>
    </div>
  );
